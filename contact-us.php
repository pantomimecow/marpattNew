		...
		<section class="content news about">
			<div class="gridText">
				<article id="about_text">
					...
					<p>By Phone : 0116 2743943</p>

					<p>By Fax : 0116 2743944</p>

					<p>By Email : <a href="sales@marpatt.co.uk?subject=Enquiry from the website">sales@marpatt.co.uk</a></p>

					<p>In Writing<br>Marpatt,<br>Albert House,<br>Victoria Heights Industrial Estate,<br>30 Lewisher Road Leicester<br>LE4 9LR</p>
				</article>
			
				<img src="img/blueSky.jpg" alt="" id="bluesky">
				<section class="clear">
				...
				<label for="hear">Were did you hear about us?</label>
					...
					<textarea name="message" onclick="this.value='';" onfocus="this.select()" onblur="this.value=!this.value?'Your Message':this.value;">Your Message</textarea>
					</fieldset>
					</div>
				<div class="col">	
